...
{
    return "Lowest possible grade for RobotomyRequestForm execution is 5";
}
...
RobotomyRequestForm::~RobotomyRequestForm(){std::cout << "Destructor for Presidential Pardon Form has been invoked";}